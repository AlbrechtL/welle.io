...
//	Note that our DAB environment maps the softbits to -255 .. 255
//	we have to map that onto 0 .. 255
//	Note that our generator delivers -255 = 1  +255 = 0
...
//In case you want to experiment, comment previous lin e
