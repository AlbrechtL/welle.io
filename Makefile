#############################################################################
# Makefile for building: linux-bin/dab-rpi-0.994
...
CC            = gcc
CXX           = g++
DEFINES       = -DMOT_BASICS__ -DHAVE_DABSTICK -DHAVE_SDRPLAY -DSDRPLAY_LIBRARY_NEW -DHAVE_AIRSPY -DHAVE_STREAMER -DHAVE_RTL_TCP -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = dab-rpi-0.9941.0.0
DISTDIR = /usr/shared/sdr-j-development/systems/dab-rpi/.tmp/dab-rpi-0.9941.0.0
LINK          = g++
...
QMAKE_TARGET  = dab-rpi-0.994
DESTDIR       = linux-bin/#avoid trailing-slash linebreak
TARGET        = linux-bin/dab-rpi-0.994
...
moc_gui.cpp: includes/dab-constants.h \
		...
		includes/backend/deconvolve.h \
		gui.h
	/usr/lib64/qt5/bin/moc $(DEFINES) -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/dab-rpi -I/usr/shared/sdr-j-development/systems/dab-rpi -I/usr/shared/sdr-j-development/systems/dab-rpi -I/usr/shared/sdr-j-development/systems/dab-rpi/src -I/usr/shared/sdr-j-development/systems/dab-rpi/includes -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/ofdm -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/backend -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/output -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/various -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/rawfiles -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/wavfiles -I/usr/local/include -I/home/jan/rtl-sdr/include -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/dabstick-new -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/sdrplay -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/airspy -I/usr/local/include/libairspy -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/rtl_tcp -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtCore -I/usr/include/c++/5.3.1 -I/usr/include/c++/5.3.1/x86_64-redhat-linux -I/usr/include/c++/5.3.1/backward -I/usr/lib/gcc/x86_64-redhat-linux/5.3.1/include -I/usr/local/include -I/usr/include gui.h -o moc_gui.cpp
