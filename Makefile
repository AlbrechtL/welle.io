...
CC            = gcc
CXX           = g++
DEFINES       = -DMOT_BASICS__ -DMSC_DATA__ -DGUI_1 -DHAVE_DABSTICK -DHAVE_SDRPLAY -DSDRPLAY_LIBRARY_NEW -DHAVE_AIRSPY -DHAVE_RTL_TCP -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB
...
INCPATH       = -I. -I. -I. -Isrc -Iincludes -Iincludes/ofdm -Iincludes/backend -Iincludes/backend/audio -Iincludes/backend/data -Iincludes/backend/data/journaline -Iincludes/output -Iincludes/various -Isrc/input -Isrc/input/rawfiles -Isrc/input/wavfiles -I../../../../local/include -Igui_1 -I/home/jan/rtl-sdr/include -Isrc/input/dabstick-osmo -Isrc/input/sdrplay -Isrc/input/airspy -I../../../../local/include/libairspy -Isrc/input/rtl_tcp -I../../../../include/qt5 -I../../../../include/qt5/QtWidgets -I../../../../include/qt5/QtGui -I../../../../include/qt5/QtNetwork -I../../../../include/qt5/QtCore -I. -I. -I../../../../lib64/qt5/mkspecs/linux-g++
...
moc_ofdm-processor.cpp: includes/dab-constants.h \
		...
		includes/backend/deconvolve.h \
		includes/ofdm/ofdm-processor.h
	/usr/lib64/qt5/bin/moc $(DEFINES) -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/dab-rpi -I/usr/shared/sdr-j-development/systems/dab-rpi -I/usr/shared/sdr-j-development/systems/dab-rpi -I/usr/shared/sdr-j-development/systems/dab-rpi/src -I/usr/shared/sdr-j-development/systems/dab-rpi/includes -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/ofdm -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/backend -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/backend/audio -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/backend/data -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/backend/data/journaline -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/output -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/various -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/rawfiles -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/wavfiles -I/usr/local/include -I/usr/shared/sdr-j-development/systems/dab-rpi/gui_1 -I/home/jan/rtl-sdr/include -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/dabstick-osmo -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/sdrplay -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/airspy -I/usr/local/include/libairspy -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/rtl_tcp -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtCore -I/usr/include/c++/5.3.1 -I/usr/include/c++/5.3.1/x86_64-redhat-linux -I/usr/include/c++/5.3.1/backward -I/usr/lib/gcc/x86_64-redhat-linux/5.3.1/include -I/usr/local/include -I/usr/include includes/ofdm/ofdm-processor.h -o moc_ofdm-processor.cpp
