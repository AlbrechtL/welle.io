...
CC            = gcc
CXX           = g++
DEFINES       = -DMOT_BASICS__ -DMSC_DATA__ -DSSE_AVAILABLE -DGUI_1 -DHAVE_DABSTICK -DHAVE_SDRPLAY -DHAVE_AIRSPY -DHAVE_RTL_TCP -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB
...
LINK          = g++
LFLAGS        = -flto -Wl,-O1
LIBS          = $(SUBLIBS) -lfftw3f -lusb-1.0 -ldl -lportaudio -lz -lsndfile -lfaad -lQt5Widgets -lQt5Gui -lQt5Network -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
moc_ofdm-processor.cpp: includes/dab-constants.h \
		...
		includes/ofdm/ofdm-processor.h \
		moc_predefs.h
	/usr/lib64/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/dab-rpi -I/usr/shared/sdr-j-development/systems/dab-rpi -I/usr/shared/sdr-j-development/systems/dab-rpi -I/usr/shared/sdr-j-development/systems/dab-rpi/src -I/usr/shared/sdr-j-development/systems/dab-rpi/includes -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/ofdm -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/backend -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/backend/audio -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/backend/data -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/backend/data/journaline -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/output -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/various -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/rawfiles -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/wavfiles -I/usr/local/include -I/usr/shared/sdr-j-development/systems/dab-rpi/gui_1 -I/home/jan/rtl-sdr/include -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/dabstick-osmo -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/sdrplay-exp -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/airspy -I/usr/local/include/libairspy -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/rtl_tcp -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtCore -I/usr/include/c++/6.1.1 -I/usr/include/c++/6.1.1/x86_64-redhat-linux -I/usr/include/c++/6.1.1/backward -I/usr/lib/gcc/x86_64-redhat-linux/6.1.1/include -I/usr/local/include -I/usr/include includes/ofdm/ofdm-processor.h -o moc_ofdm-processor.cpp
