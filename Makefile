#############################################################################
# Makefile for building: linux-bin/dab-rpi-0.996
...
CC            = gcc
CXX           = g++
DEFINES       = -DFULL_CORRELATION -DMOT_BASICS__ -DMSC_DATA__ -DGUI_1 -DHAVE_DABSTICK -DHAVE_SDRPLAY -DSDRPLAY_LIBRARY_NEW -DHAVE_AIRSPY -DHAVE_RTL_TCP -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB
...
INCPATH       = -I. -I. -I. -Isrc -Iincludes -Iincludes/ofdm -Iincludes/backend -Iincludes/backend/audio -Iincludes/backend/data -Iincludes/output -Iincludes/various -Isrc/input -Isrc/input/rawfiles -Isrc/input/wavfiles -I../../../../local/include -Igui_1 -I/home/jan/rtl-sdr/include -Isrc/input/dabstick-new -Isrc/input/sdrplay -Isrc/input/airspy -I../../../../local/include/libairspy -Isrc/input/rtl_tcp -I../../../../include/qt5 -I../../../../include/qt5/QtWidgets -I../../../../include/qt5/QtGui -I../../../../include/qt5/QtNetwork -I../../../../include/qt5/QtCore -I. -I. -I../../../../lib64/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = dab-rpi-0.9961.0.0
DISTDIR = /usr/shared/sdr-j-development/systems/dab-rpi/.tmp/dab-rpi-0.9961.0.0
LINK          = g++
...
QMAKE_TARGET  = dab-rpi-0.996
DESTDIR       = linux-bin/#avoid trailing-slash linebreak
TARGET        = linux-bin/dab-rpi-0.996
...
$(TARGET): ui_filereader-widget.h ui_gui_1.h ui_dabstick-widget.h ui_sdrplay-widget.h ui_airspy-widget.h ui_rtl_tcp-widget.h $(OBJECTS)  
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/input/filereader-widget.ui gui_1/gui_1.ui src/input/dabstick-new/dabstick-widget.ui src/input/sdrplay/sdrplay-widget.ui src/input/airspy/airspy-widget.ui src/input/rtl_tcp/rtl_tcp-widget.ui $(DISTDIR)/
...
moc_ofdm-processor.cpp: includes/dab-constants.h \
		...
		includes/backend/deconvolve.h \
		includes/ofdm/ofdm-processor.h
	/usr/lib64/qt5/bin/moc $(DEFINES) -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/dab-rpi -I/usr/shared/sdr-j-development/systems/dab-rpi -I/usr/shared/sdr-j-development/systems/dab-rpi -I/usr/shared/sdr-j-development/systems/dab-rpi/src -I/usr/shared/sdr-j-development/systems/dab-rpi/includes -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/ofdm -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/backend -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/backend/audio -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/backend/data -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/output -I/usr/shared/sdr-j-development/systems/dab-rpi/includes/various -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/rawfiles -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/wavfiles -I/usr/local/include -I/usr/shared/sdr-j-development/systems/dab-rpi/gui_1 -I/home/jan/rtl-sdr/include -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/dabstick-new -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/sdrplay -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/airspy -I/usr/local/include/libairspy -I/usr/shared/sdr-j-development/systems/dab-rpi/src/input/rtl_tcp -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtCore -I/usr/include/c++/5.3.1 -I/usr/include/c++/5.3.1/x86_64-redhat-linux -I/usr/include/c++/5.3.1/backward -I/usr/lib/gcc/x86_64-redhat-linux/5.3.1/include -I/usr/local/include -I/usr/include includes/ofdm/ofdm-processor.h -o moc_ofdm-processor.cpp
...
compiler_uic_make_all: ui_filereader-widget.h ui_gui_1.h ui_dabstick-widget.h ui_sdrplay-widget.h ui_airspy-widget.h ui_rtl_tcp-widget.h
compiler_uic_clean:
	-$(DEL_FILE) ui_filereader-widget.h ui_gui_1.h ui_dabstick-widget.h ui_sdrplay-widget.h ui_airspy-widget.h ui_rtl_tcp-widget.h
