#############################################################################
# Makefile for building: linux-bin/sdr-j-rpi-0.992
...
CC            = gcc
CXX           = g++
DEFINES       = -DHAVE_DABSTICK -DHAVE_SDRPLAY -DSDRPLAY_LIBRARY_NEW -DHAVE_AIRSPY -DHAVE_STREAMER -DHAVE_RTL_TCP -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = sdr-j-rpi-0.9921.0.0
DISTDIR = /home/jan/dab-rpi/.tmp/sdr-j-rpi-0.9921.0.0
LINK          = g++
...
QMAKE_TARGET  = sdr-j-rpi-0.992
DESTDIR       = linux-bin/#avoid trailing-slash linebreak
TARGET        = linux-bin/sdr-j-rpi-0.992
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_gui.cpp moc_ofdm-processor.cpp moc_ofdm-decoder.cpp moc_fic-handler.cpp moc_fib-processor.cpp moc_mp2processor.cpp moc_mp4processor.cpp moc_pad-handler.cpp moc_dabstick.cpp moc_dongleselect.cpp moc_sdrplay.cpp moc_airspy-handler.cpp moc_streamer.cpp moc_rtl_tcp_client.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_gui.cpp moc_ofdm-processor.cpp moc_ofdm-decoder.cpp moc_fic-handler.cpp moc_fib-processor.cpp moc_mp2processor.cpp moc_mp4processor.cpp moc_pad-handler.cpp moc_dabstick.cpp moc_dongleselect.cpp moc_sdrplay.cpp moc_airspy-handler.cpp moc_streamer.cpp moc_rtl_tcp_client.cpp
